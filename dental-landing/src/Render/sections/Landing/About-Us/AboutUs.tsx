  ...
  return (
    <main className="relative bg-background lg:pt-[183px]" id="nosotros">
      <section className="max-w-[1530px] mx-auto">
        <div className="about-us-img relative isolate overflow-hidden flex flex-col sm:flex-row justify-center items-center mx-auto px-4 max-xl:px-[80px]">
          {/* Text and Title Container */}
          <div className="flex flex-col justify-center lg:mb-[107px] lg:gap-[20px] max-md:mt-10">
            {/* Section Titile */}
            <div className="sectionTitle w-[139px] h-[39px] lg:w-[188px] lg:h-[48px] max-lg:mt-[53px] max-md:mr-[215px]">
              <p className="text-[19px] lg:text-[28px] leading-[120%]">
                Nosotros
              </p>
            </div>
            <div className="mt-[38px] max-2xl:max-w-[590px] mb-[55px] lg:mb-[0px]">
              {/* Us Text */}

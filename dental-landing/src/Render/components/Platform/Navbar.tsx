        ...
        >
          <div className="flex flex-col gap-10 justify-center w-3/5 h-[700px] mx-auto">
            ...
            <div className="flex items-start gap-1 mt-[100px]">
              ...
              {/* {dropdownVisible && (
                <div
                  className=" poppins-semibold text-[16px] absolute z-10 mt-[350px] w-auto origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                  role="menu"
                ...
                >
                  ...
                  >
                    ...
                    <button
                      className="flex poppins-semibold text-lg w-[200px] p-3 text-black bg-white rounded-full hover:shadow items-center justify-center"
                      onClick={logout}
                    >
                      Cerrar sesión
                    </button>
